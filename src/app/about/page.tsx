...
export default function About() {
  return (
    <div className="flex min-h-screen font-[family-name:var(--font-geist-sans)]">
      {/* Hero Slider */}
      <div className="absolute top-[-75px] left-0 w-full h-[500px] overflow-hidden opacity-40">
        <VideoPlayer
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col items-center sm:items-start pt-[500px]">
